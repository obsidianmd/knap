...
const docs: FilterDoc[] = [
  ...
  },
  {
    ...
    notes: ['Arrays of objects use object keys as headers. Arrays of arrays use each nested array as a row. Simple arrays use a single “Value” column unless custom headers are supplied.'], related: ['list'],
    examples: [
