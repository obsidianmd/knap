...
describe('replace_tags filter', () => {
	...
	test.each(['"strong":"h2"', 'strong:h2', '("strong":"h2")'])
	...
	test('keeps comma-separated transformations independent', () => {
		expect(replace_tags('<b>bold</b><em>emphasis</em>', 'b,em')).toBe('boldemphasis');
		expect(replace_tags('<b>bold</b><em>emphasis</em>', 'b,"em":"i"'))
